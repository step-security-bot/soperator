...
type SlurmClusterSpec struct {
	...
	// SlurmKeySecretName defines the name of the Secret required for inter-server communication of Slurm nodes
	//
	// +kubebuilder:validation:Required
	SlurmKeySecretName string `json:"slurmKeySecretName,omitempty"`
